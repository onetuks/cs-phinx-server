...
public class AnswerFixture {
  ...
  public static AnswerCommand createAnswerAddCommand(long problemId, AnswerType answerType) {
    return new AnswerCommand(problemId, answerType, createAnswerValues(answerType));
  }
